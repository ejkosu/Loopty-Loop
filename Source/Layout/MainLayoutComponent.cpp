...
//==============================================================================
MainLayoutComponent::MainLayoutComponent(juce::AudioProcessorValueTreeState& vts, juce::DialogWindow::LaunchOptions& dialogOptions)
    : audioTracks(vts),
      mixer(vts),
      transportControls(vts, dialogOptions)
{
